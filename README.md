...
**Masalah Umum:**
- Tidak muncul info sistem, IP address, atau storage setelah login ke EC2.

**Solusi:**
- Jalankan perintah berikut secara manual di terminal:
  ```bash
  df -h         # Melihat kapasitas storage
  ip a          # Melihat IP internal dan eksternal
  uname -a      # Melihat detail OS/server
